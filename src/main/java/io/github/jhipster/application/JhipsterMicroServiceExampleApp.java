...
public class JhipsterMicroServiceExampleApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterMicroServiceExampleApp.class);

    private final Environment env;

    public JhipsterMicroServiceExampleApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterMicroServiceExample.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterMicroServiceExampleApp.class);
